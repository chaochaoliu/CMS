...
class SermonsControllerTest < ActionController::TestCase
  ...
  test "should create sermon" do
    assert_difference('Sermon.count') do
      post :create, sermon: { category: @sermon.category, content: @sermon.content, date: @sermon.date, preacher: @sermon.preacher, title: @sermon.title }
    end
  ...
  test "should update sermon" do
    patch :update, id: @sermon, sermon: { category: @sermon.category, content: @sermon.content, date: @sermon.date, preacher: @sermon.preacher, title: @sermon.title }
    assert_redirected_to sermon_path(assigns(:sermon))
  end
